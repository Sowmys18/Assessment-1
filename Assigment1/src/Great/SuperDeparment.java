...
public static void main(String[] args) {
	SuperDeparment adminObj = new AdminDepartment();
	...
	SuperDeparment hrObj = new HrDepartment();
...
class HrDepartment extends SuperDeparment{
String departmentName() {
...
class TechDepartment extends SuperDeparment{
	String departmentName() {
